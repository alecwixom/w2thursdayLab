...
fruits.forEach((fruit, indexNum) => {
  if (fruit.color === 'red' && fruit.name === 'apple') {
    console.log(`The fruit with index ${indexNum} is an apple.`);
  } else if (fruit.color === 'orange' && fruit.name === 'orange') {
    console.log(`The fruit with index ${indexNum} is an orange.`);
  } else {
    console.log(`The fruit with index ${indexNum} is neither apple or orange.`);
  }
});
...
let totalPrice = foods.filter ((food) => {
